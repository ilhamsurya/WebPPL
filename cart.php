		...
		if($value > 0){
			if(substr($name, 0, 5) == 'cart_'){
				...
				while($get_row = mysqli_fetch_assoc($get)){
					...
					echo '	<a href="tampil_barang.php?remove='.$row['produk_id'].'">[-]</a> 
					<a href="tampil_barang.php?add='.$row['produk_id'].'">[+]</a> 
					<a href="tampil_barang.php?delete='.$row['produk_id'].'" onclick="return confirm(\'Anda Yakin?\');">[x]</a><br>';
					echo '<br>';
